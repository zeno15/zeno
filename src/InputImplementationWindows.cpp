...
bool InputImplementation::isKeyDown(Keyboard::Key _key)
{
	...
	case Keyboard::Fullstop:		vkey = VK_OEM_PERIOD; break;
	case Keyboard::Quote:			vkey = VK_OEM_7;      break;
	case Keyboard::ForwardSlash:	vkey = VK_OEM_2;      break;
	case Keyboard::BackwardSlash:	vkey = VK_OEM_5;      break;
	case Keyboard::Tilde:			vkey = VK_OEM_3;      break;
	case Keyboard::Equals:			vkey = VK_OEM_PLUS;   break;
